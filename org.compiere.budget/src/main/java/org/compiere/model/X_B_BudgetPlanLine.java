...
/** Generated Model for B_BudgetPlanLine
 *  @author Adempiere (generated) 
 *  @version 1.7.07 - $Id$ */
public class X_B_BudgetPlanLine extends PO implements I_B_BudgetPlanLine, I_Persistent 
{
    ...
    public X_B_BudgetPlanLine (Properties ctx, int B_BudgetPlanLine_ID, String trxName)
    {
      super (ctx, B_BudgetPlanLine_ID, trxName);
      /** if (B_BudgetPlanLine_ID == 0)
        {
    ...
    /** Load Constructor */
    public X_B_BudgetPlanLine (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_B_BudgetPlanLine[")
